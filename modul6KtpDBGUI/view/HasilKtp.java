...
public class HasilKtp {
    ...
    public HasilKtp(ArrayList<Penduduk> penduduk) {
        ...
        //ini button back to main menu
        back = new JButton("Back to Main Menu");
        back.setBounds(150, 350, 180, 20);
    ...
    private void viewPict() {
        String selectedFotoPath = Penduduk.getSelectedFotoPath();
    ...
    private void viewPict2() {
        String selectedTtdPath = Penduduk.getSelectedTtdPath();
