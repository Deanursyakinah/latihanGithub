    ...
    public Perekaman() {
        ...
        buttonSubmit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Date tanggalLahirValue = new java.sql.Date(((java.util.Date) datePicker.getModel().getValue()).getTime());
                ...
                Date tanggalPembuatanKtpValue = new java.sql.Date(((java.util.Date) datePicker2.getModel().getValue()).getTime());
                ...
                control.insertNewPenduduk(orang);
                JOptionPane.showMessageDialog(null, "insert berhasil");
            }
        });

        buttonBack = new JButton("BACK");
        buttonBack.setBounds(125, 630, 100, 20);
        buttonSubmit.setEnabled(true);
